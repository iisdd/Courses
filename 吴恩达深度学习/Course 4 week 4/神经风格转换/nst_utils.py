...
def generate_noise_image(content_image, noise_ratio = CONFIG.NOISE_RATIO): # ratio默认0.6
    """
...
def reshape_and_normalize_image(image):
    ...
    image = np.reshape(image, ((1,) + image.shape)) # 相当于加了个数量的维度: m
