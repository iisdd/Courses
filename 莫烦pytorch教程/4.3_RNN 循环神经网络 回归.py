"""
主要内容:输入sin(t)的蓝色曲线来跟踪cos(t)的红色曲线
"""
import torch
...
INPUT_SIZE = 1  # rnn input size, 验一推一
...
class RNN(nn.Module):
    ...
    def forward(self, x, h_state):
        ...
        r_out, h_state = self.rnn(x, h_state) # 循环利用h_state
...
h_state = None  # 全用0初始化hidden_state
...
for step in range(100):
    ...
    # h_state输出和输入的形式不一样了,要重新包装一下再送进下一次循环
