# 用cnn来当作encoder抽取文本信息,就本任务来说,比LSTM拉胯
...
class CNNTranslation(keras.Model):
    def __init__(self, enc_v_dim, dec_v_dim, emb_dim, units, max_pred_len, start_token, end_token):
        ...
        self.conv2ds = [
            ...
            for n in range(2, 5)]   # 不同'眼界'的filter,长度分别为2,3,4,即连读2,3,4个字
        self.max_pools = [keras.layers.MaxPool2D((n, 1)) for n in [7, 6, 5]]    # 再池化成同样的形状
